...
function calc() {
  var calcBlock = document.querySelector('.calculating'),
  ...
  var generateErrText = function generateErrText() {
  ...
  var calculate = function calculate() {
    ...
    result.innerHTML = "\n            <div class=\"calculating__subtitle\">\n                \u0412\u0430\u0448\u0430 \u0441\u0443\u0442\u043E\u0447\u043D\u0430\u044F \u043D\u043E\u0440\u043C\u0430 \u043A\u0430\u043B\u043E\u0440\u0438\u0439:\n            </div>\n            <div class=\"calculating__result\">\n                <span>".concat(expression, "</span> \u043A\u043A\u0430\u043B\n            </div>\n        ");
  };
  ...
  var activateClass = function activateClass(elements, item, localName, localVal) {
...
/* harmony import */ var _services_services_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/services.js */ "./js/services/services.js");
...
function cards() {
  var FoodCard = /*#__PURE__*/function () {
    function FoodCard(imgUrl, alt, title, text, price, parentSelector) {
      _classCallCheck(this, FoodCard);
  ...
  (0,_services_services_js__WEBPACK_IMPORTED_MODULE_3__.getResourses)('http://localhost:3000/menu').then(function (data) {
...
/* harmony import */ var _modal_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modal.js */ "./js/modules/modal.js");
...
function forms(formSelector) {
  ...
  var showThanksModal = function showThanksModal(m) {
    var prevModalDialog = document.querySelector('.modal__dialog'),
        modal = document.querySelector('.modal');
    prevModalDialog.classList.add('hide');
    (0,_modal_js__WEBPACK_IMPORTED_MODULE_8__.modalShow)('.modal');
    var thanksModal = document.createElement('div');
    thanksModal.classList.add('modal__dialog');
    thanksModal.innerHTML = "\n            <div class=\"modal__content\">\n                <div class=\"modal__close\" data-close>&times;</div>\n                <div class=\"modal__title\">".concat(m, "</div>\n            </div>\n        ");
    modal.append(thanksModal);
    setTimeout(function () {
      thanksModal.remove();
      prevModalDialog.classList.add('show');
      prevModalDialog.classList.remove('hide');
      (0,_modal_js__WEBPACK_IMPORTED_MODULE_8__.modalClose)('.modal', 'close');
    }, 4000);
  };
}
...
/* harmony export */   "modalShow": function() { return /* binding */ modalShow; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.for-each */ "./node_modules/core-js/modules/es.array.for-each.js");
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
var modalShow = function modalShow(modalSelector, modalTimerId) {
...
var modalClose = function modalClose(modalSelector) {
  var e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : modal.querySelector('.modal__close');
  return function () {
    var modal = document.querySelector(modalSelector);
    var t = e.target;
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  var modalBtns = document.querySelectorAll(triggerSelector),
...
function slider(_ref) {
  ...
  if (sliderItems.length < 10) {
    total.textContent = "0".concat(sliderItems.length);
  } else {
  ...
  var changeSlide = function changeSlide() {
    ...
    var changeCurrentDot = function changeCurrentDot(n) {
    ...
    var changeCurrentNum = function changeCurrentNum(n) {
    ...
    if (dir === 'next') {
      ...
      sliderInner.style.transform = "translateX(-".concat(step * sliderWidth, "px)");
      ...
      step = dir;
      sliderInner.style.transform = "translateX(-".concat(dir * sliderWidth, "px)");
...
function timer(id, deadline) {
  ...
  function setClock(selector, endtime) {
    ...
    function updateClock() {
      var time = getTimeRemaning(endtime);
...
__webpack_require__(/*! es6-promise */ "./node_modules/es6-promise/dist/es6-promise.js").polyfill(); // json-server db.json
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.modalShow)('.modal', modalTimerId);
  }, 30000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_0__.default)('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__.default)('.timer', '2020-11-11');
...
/*!*********************************!*\
  ...
  \*********************************/
/*! namespace exports */
/*! export getResourses [provided] [no usage info] [missing usage info prevents renaming] */
...
/* harmony export */   "getResourses": function() { return /* binding */ getResourses; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat */ "./node_modules/core-js/modules/es.array.concat.js");
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_object_to_string__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.object.to-string */ "./node_modules/core-js/modules/es.object.to-string.js");
...
var getResourses = /*#__PURE__*/function () {
  ...
  return function getResourses(_x3) {
